...
function changeElement (answer){
    const input=document.getElementById(answer);
    input.style.backgroundColor="$textColor9";
    input.style.border="1px solid $textColor2";
